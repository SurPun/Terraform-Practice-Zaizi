...
resource "aws_codebuild_project" "example" {
  ...
  service_role = "arn:aws:iam::900332192728:role/tf-codebuild-role"
...
resource "aws_codepipeline" "example" {
  ...
  role_arn = "arn:aws:iam::900332192728:role/tf-codepipeline-role"

  artifact_store {
    location = "pipeline-artifacts-surpun"
    type     = "S3"
  }
